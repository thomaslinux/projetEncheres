...
FOREIGN KEY ARTICLE (id_categorie) REFERENCES CATEGORIE (id_categorie)
...
FOREIGN KEY ENCHERE (id_utilisateur)
REFERENCES UTILISATEUR (id_utilisateur)
ON UPDATE NO ACTION ON DELETE NO ACTION;

ALTER TABLE ENCHERE ADD CONSTRAINT enchere_article_fk
FOREIGN KEY ENCHERE (id_article)
...
FOREIGN KEY RETRAIT (id_article) REFERENCES ARTICLE (id_article)
ON UPDATE NO ACTION ON DELETE NO ACTION;
